...
##  The SM Action Checklist: Immediately After the SoS
...
### 2. Resolve "Dependency Handshakes"
**Action:** Don't just report the dependency—link the people.
...
### 5. Feed the Retrospective
**Action:** Identify systemic patterns.
* *Execution:* If the same blocker appears three days in a row, document it for the Retrospective: "We are consistently blocked by the API team. Let’s change our working agreement."
...
| Step | Action |
| :--- | :--- |
| **Communicate** | Inform the Android sub-team: "iOS found a bridge bug. Check the Android implementation today for the same vulnerability." |
| **Facilitate** | Set up a 20-min "Bridge Sync" between iOS and Android leads to share findings. |
| **Adjust** | Notify the PO: "This fix takes 1 day. We are pushing the 'Profile Picture' feature to next sprint to accommodate." |
| **Document** | Log the bug as a **Technical Spike** so the team gets credit and the risk is visible to leadership. |
